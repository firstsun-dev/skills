...
One file per calendar month. Completed work, moved out of `progress.md` to keep that file scannable. Newest first.

## 2026-07-06

- feat-009: Added archive/YYYY-MM.md cleanup cadence + state-hygiene check to harness-creator (commit 3b3a18a)
